...
def logout_user(request):
    logout(request)
    messages.success(request, "You have Been Logged Out... Thanks For Using The System.")
    return redirect('home')
...
def delete_record(request, pk):
    if request.user.is_authenticated:
        ...
        messages.success(request, "You mjust be logged in To accomplish that task...!")
        return redirect('home')
...
def add_record(request):
    ...
    if request.user.is_authenticated:
        ...
        messages.success(request, "You must be logged in to accomplish that ...!")
        return redirect('home')
